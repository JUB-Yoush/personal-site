...
It should be challenging for sure, but _how_ challenging? Am I mid? I was definitely too reliant on my hosts, and I started trying to focus on figuring out how to find the answer instead of asking for the answer from them, because that's what they were doing after all (they don't know everything, there's too much to know).
