...
If Alexey Pajitnov hadn't come up with in 1984, would somebody else have?

Of course you can ask this question of any video game, or any innovation in anything. But Tetris stands out to me as an interesting game to ask this questions about because it's so... Perfect.

Tetris was complete the day it came out. A few simple systems based on math concepts and tetromino puzzle games to create a game that was so simple but so innovate, understood in an instant but could be enjoyed for a lifetime. All of it's few systems work perfectly with one another to make a game where there isn't really anywhere left to take it. The Tetris of 1984 is effectively the Tetris of today, with little modification. Tetris is a perfect video game. How many more games like Tetris are out there to be found? How many more perfect video games exist? I don't know, but I do know that games like these fascinate me as a designer, 

Tetris is the final form of itself.

I'll be the first person to tell you that ideas don't come out of the ether from nothing, and we can trace back the origin of Tetris to math concepts and Pajitnov playing with tetromino puzzles as a child, but something about it's simplicity and elegance makes it feel like it just manifested completely in the primordial soup. I can't imagine a world without Tetris. And I think about tetris sort of frequently. How many more tetrises are there? How many more genres of games are there that nobody has thought to make yet? Do other games have a platonic ideal, a final form that it's waiting to achieve?

As game designers, we push the bounds of what we know to be possible, but we also focus in on the things we know are possible, and try to make them reach their platonic ideal (does that imply there is one perfect version of each genre?)

I have broadly categorized this thinking into honing and innovating in game design.
...
## Shmups are Simple.
You dodge the bullets that come from the top of the screen and shoot up back at the things shooting at you. sure there are evolutions to the genre like twin stick and 3d-rail shooters, but let's stick to classic shmups.

In 1998, The Tokyo based game studio Treasure released Radiant Silvergun to Japanese Arcades (Later ported to the Sega Saturn, and modern consoles later).

## a description of radiant silvergun.
Radiant Silvergun is a shmup that features 6 different types of shots: 
- a straight cannon 
- homing laser 
- side bombs 
- rear shots
...
There is also a combo system. Enemies are either red blue or yellow. Kill enemies of the same color to increase your chain. There are also occasionally "secret" chains in certain sections of levels that require you to kill enemies in specific color orders.

There is a lot to rs, if you didn't catch everything I just talked about that's fine (and kinda the point) a lot of different, seeming separate systems that all come together through genius design to create one of the best shmups of all time. (It's really good) it's on steam now! play it!

but with the peak of shmups being achieved, where would treasure go from here? rs is filled to the brim, they couldn't make a sequel with more systems to try and fold into all the existing ones.

So they started from scratch, and in 2001 they released Ikaruga.

## "Oh, that's the one were you switch colours!"
If that was the thought that occurred to you when you read Ikaruga (or clicked on the mobygames link and saw screenshots of it), then that's kinda indicative of the point that this post is about. Ikaruga is a simple game that is designed around one mechanic.

## a description of ika
- everything is either white or black. you can swap between white mode and black mode. 
- you absorb same color bullets (and fill a missile charge) opposite colour bullets kill you.
- you have one type of shot. you deal double damage by shooting enemies with the opposite color.
- you have a missile barrage (good ol [itano circus]()) that you can fire by spending a your missile charge.
- enemies of the same color as you return fire upon death.
- kill enemies in groups of 3 of the same color to maintain your combo and increase your score. you get an extra life every 3 million points.
...
- the charge missles is much more powerful than your standard shot, so thinking about how you'll gain the charge to release it, and when to release it, are factors in thinking about positioning and about what color to be.
- the comboing system is the most elegant addition, and is an interesting point of comparison from this to rs. in rs, combing is also well designed and thought out and fun, but it is arbitrary. enemies are 1 of 3 colors for the sake of comboing, it's just one seperate system in a game full of seperate systems that all come together. 

ika ties combing directly into it's central mechanic of colors. enemies aren't black or white to be combo'ed, they're black and white because that's what the entire game is about, comboing is simply a natural extension of the existing color system. (that and ika dosen't have you ignore 2/3rds of the enemies on the screen for your score)
...
Ikaruga is a puzzle game in the sense that it makes you think a lot more than usual. return fire, combo routing, and when to switch. 
...
I like to consider the Ikaruga style of design "novelty based design".

novelty based design: games that are hyperfocused on and revolve around a novel idea or concept.
